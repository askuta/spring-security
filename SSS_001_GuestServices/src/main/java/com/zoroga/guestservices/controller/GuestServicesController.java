package com.zoroga.guestservices.controller;
...
import com.zoroga.guestservices.entity.Guest;
import com.zoroga.guestservices.exception.GuestNotFoundException;
import com.zoroga.guestservices.model.GuestModel;
import com.zoroga.guestservices.repository.GuestRepository;
...
public class GuestServicesController {
	...
	public ResponseEntity<Guest> addGuest(@RequestBody GuestModel model) {
		...
		LOGGER.info("Built location: " + location);
